            ...
            public void handle(DragEvent event) {
                ...
                if (event.getPickResult().getIntersectedNode() instanceof StackPane) {
                    ...
                    if (COMP == NOT){
                        ...
                        Controller.Anchor start_IN1 = new Controller.Anchor(Color.PALEGREEN, startX, startY, toAdd, COMP.getId(), null);
                        Controller.Anchor start_OUT = new Controller.Anchor(Color.PALEGREEN, startX_OUT, startY_OUT, toAdd, COMP.getId(), null);
                        Controller.Anchor end_OUT = new Controller.Anchor(Color.TOMATO, endX_OUT, endY_OUT, toAdd, COMP.getId(), "OUT");

                        Constructor.getChildren().add(start_IN1);
                        Constructor.getChildren().add(start_OUT);
                        Constructor.getChildren().add(end_OUT);

                        Line lineOUT = new Controller.BoundLine(startX_OUT, startY_OUT, endX_OUT, endY_OUT, toAdd);
                        ...
                        Controller.Anchor start_IN2 = new Controller.Anchor(Color.PALEGREEN, startX_2, startY_2, toAdd, COMP.getId(), null);
                        ...
                        Line line = new Controller.BoundLine(startX, startY, endX, endY, toAdd);
                        Line line2 = new Controller.BoundLine(startX_2, startY_2, endX_2, endY_2, toAdd);
                        Line lineOUT = new Controller.BoundLine(startX_OUT, startY_OUT, endX_OUT, endY_OUT, toAdd);
...
//_________________________________/ CIRCULOS /__________________________
    ...
    public class Anchor extends Circle {
        ...
        private void enableDrag(Compuerta toAdd) {
            final Controller.Anchor.Delta dragDelta = new Controller.Anchor.Delta();
        ...
        public void sendOp(Node IntersectedNode, int VALOR, Object source) {
            ...
            if (IntersectedNode instanceof Controller.Anchor) {
